...
#define EINA_COVER(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST ((obj), EINA_TYPE_COVE, EinaCover))

#define EINA_COVER_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST ((klass), EINA_TYPE_COVE, EinaCoverClass))
...
LomoPlayer *lomo eina_cover_get_lomo_player(EinaCover *self);

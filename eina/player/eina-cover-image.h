/*
 * eina/player/eina-cover-image.h
 *
...
void     eina_cover_image_set_as_is(EinaCoverImage *self, gboolean as_is);
gboolean eina_cover_image_get_as_is(EinaCoverImage *self);

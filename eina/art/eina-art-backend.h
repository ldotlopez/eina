...
#define EINA_ART_BACKEND(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), EINA_TYPE_ART_BACKEND, EinaArtBackend))
#define EINA_ART_BACKEND_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass),  EINA_TYPE_ART_BACKEND, EinaArtBackendClass))
#define EINA_IS_ART_BACKEND(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), EINA_TYPE_ART_BACKEND))
#define EINA_IS_ART_BACKEND_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass),  EINA_TYPE_ART_BACKEND))
...
EinaArtBackend* eina_art_backend_new (const gchar *name,
